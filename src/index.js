...
class Time extends React.Component {
  ...
  renderModal() {
    ...
    if (source.modalType === "add") {
      return (
        <ModalAdd onClose={source.onClose} onSubmit={source.onAddSubmit} />
      );
      ...
      return (
        <Modal
          ...
          onSubmit={source.onDeleteSubmit}
      ...
      return (
        <Modal
          ...
          onClose={source.onClose}
          onSubmit={source.onModifySubmit}
          {...source.studentsList[source.studentIndex]}
        />
      );
    }
    ...
    return (
      <div>
        <StudentsTable
          ...
          studentsList={this.props.data.studentsList}
        />
        {this.renderModal()}
      </div>
    );
